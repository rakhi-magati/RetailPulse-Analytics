...
const typeIcon = (type: NotificationType) => {
  ...
  if (type.includes("STOCK") || type === "OVERSTOCK") {
...
export default function NotificationsPage() {
  ...
  const [filters, setFilters] =
    useState<NotificationFilters>(initial);
  ...
  const destination = (item: Notification) => {
    ...
    if (item.resource_type === "DataImport") {
      return "/data-import";
    }
      ...
      >
        ...
        >
          ...
          <Box>
            ...
            >
              Inventory, import and important operational
              alerts update automatically every 15 seconds.
            </Typography>
          </Box>
